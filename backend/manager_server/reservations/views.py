...
class CustomerRequestDetailsOld(APIView):
    permission_classes = [(IsAuthenticated & ReservationsPermissions) | (AllowAny & AnnoCusomerRequestPermissions)]
...
class CustomerRequests(ListModelMixin, RetrieveModelMixin, DestroyModelMixin, GenericViewSet):
    ...
    ordering_fields = ['email', 'created', 'status']
    ordering = 'status'
